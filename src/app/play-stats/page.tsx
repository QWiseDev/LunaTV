...
const PlayStatsPage: React.FC = () => {
  ...
  // 检查是否支持播放统计（仅非本地存储模式支持）
  const storageType =
    typeof window !== 'undefined' && (window as typeof window & { RUNTIME_CONFIG?: { STORAGE_TYPE?: string } }).RUNTIME_CONFIG?.STORAGE_TYPE
      ? (window as typeof window & { RUNTIME_CONFIG: { STORAGE_TYPE: string } }).RUNTIME_CONFIG.STORAGE_TYPE
      : 'localstorage';
            ...
            <div className='flex items-center space-x-3'>
              ...
              <div>
                ...
                <p className='text-yellow-700 dark:text-yellow-400 mt-1'>
                  当前使用本地存储模式（localStorage），不支持播放统计功能。
                  <br />
